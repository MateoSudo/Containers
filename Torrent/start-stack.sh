...
echo "   - QBittorrent: http://localhost:8083 (via VPN - also accessible via Cosmos as pia-vpn:8083)"
...
echo "   - Container: pia-vpn, Port: 8083, Domain: qbittorrent.mrintellisense.com (for QBittorrent)"
